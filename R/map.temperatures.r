  ...
  map.temperatures = function( p, outdir, plottimes, conversions, libs ) {
    ...
    # gmt.map.variables(tx, p, variables=variables, plottimes=plottimes, basedir=outdir, conversions=conversions, libs=libs)
  }

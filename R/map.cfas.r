map.cfas = function( p, conversions=c("ps2png") ) {
  ...
  polydir = file.path(project.datadirectory("emaf"), "data", "Basemaps", "Marine", "Coastline")
  ...
  cfadir =  file.path(project.datadirectory("emaf"), "data", "Management_Areas", "Fisheries", "Snowcrab")
  setwd(cfadir)

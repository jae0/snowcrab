...
Environmental factors: Temperature, Depth and Substrate
	...
	\begin{column}{0.25\textwidth}
 	\begin{figure}
    \includegraphics[width=\textwidth]{\bd/aegis/temperature/maps/SSE/bottom.predictions/climatology/{temperatures.bottom}.png}\\   
    \includegraphics[width=\textwidth]{\bd/aegis/temperature/maps/SSE/bottom.predictions/climatology/{temperatures.bottom.sd}.png}\\   
    \includegraphics[width=\textwidth]{\bd/aegis/substrate/R/{substrate.grainsize.edit}.png}  
  	\end{figure}
  	\end{column}

  	\begin{column}{0.25\textwidth}
 	\begin{figure}
    \includegraphics[width=\textwidth]{\bd/aegis/bathymetry/maps/SSE/depth.png}\\   
    \includegraphics[width=\textwidth]{\bd/aegis/bathymetry/maps/SSE/slope.png}\\   
    \includegraphics[width=\textwidth]{\bd/aegis/bathymetry/maps/SSE/curvature.png}  
  	\end{figure}
  	\end{column}
...
Environmental factors: Annual Estimates of Bottom Temperature
	...
	\begin{column}{0.25\textwidth}
 	\begin{figure}
    \includegraphics[width=\textwidth]{\bd/aegis/temperature/maps/SSE/bottom.predictions/annual/{temperatures.bottom.\yrminusfive}.png}\\   
    \includegraphics[width=\textwidth]{\bd/aegis/temperature/maps/SSE/bottom.predictions/annual/{temperatures.bottom.\yrminusthree}.png}\\   
    \includegraphics[width=\textwidth]{\bd/aegis/temperature/maps/SSE/bottom.predictions/annual/{temperatures.bottom.\yrminusone}.png}\\   
  	\end{figure}
  	\end{column}

  	\begin{column}{0.25\textwidth}
 	\begin{figure}
    \includegraphics[width=\textwidth]{\bd/aegis/temperature/maps/SSE/bottom.predictions/annual/{temperatures.bottom.\yrminusfour}.png}\\   
    \includegraphics[width=\textwidth]{\bd/aegis/temperature/maps/SSE/bottom.predictions/annual/{temperatures.bottom.\yrminustwo}.png}\\   
    \includegraphics[width=\textwidth]{\bd/aegis/temperature/maps/SSE/bottom.predictions/annual/{temperatures.bottom.\yr}.png}\\   
  	\end{figure}
  	\end{column}
...
Ecological factors: Species Composition, Species Diversity and Metabolic Rate
	...
	\begin{column}{0.25\textwidth}
 	\begin{figure}
    \includegraphics[width=\textwidth]{\bd/aegis/speciescomposition/maps/ca1/snowcrab/annual/{ca1.mean.\yr}.png}\\   
    \includegraphics[width=\textwidth]{\bd/aegis/speciesarea/maps/Npred/snowcrab/annual/{Npred.mean.\yr}.png}\\   
    \includegraphics[width=\textwidth]{\bd/aegis/metabolism/maps/mr/snowcrab/annual/{mr.mean.\yr}.png}  
  	\end{figure}
  	\end{column}

  	\begin{column}{0.25\textwidth}
 	\begin{figure}
    \includegraphics[width=\textwidth]{\bd/aegis/speciescomposition/maps/ca2/snowcrab/annual/{ca2.mean.\yr}.png}\\   
    \includegraphics[width=\textwidth]{\bd/aegis/speciesarea/maps/Z/snowcrab/annual/{Z.mean.\yr}.png}\\    
    \includegraphics[width=\textwidth]{\bd/aegis/metabolism/maps/smr/snowcrab/annual/{smr.mean.\yr}.png}  
  	\end{figure}
  	\end{column}

...
\usepackage{amsmath,amsfonts,amlbm}										% Math packages
...
Trends in biomass for potential predators/prey (log10, no\textbackslash$km^2$) of Snow Crab on the Scotian Shelf, in the Snow Crab Survey
	...
	\begin{column}{0.25\textwidth}
 	\begin{figure}
    \includegraphics[width=\textwidth]{\bds/R/maps/species/snowcrab/jonahcrab/annual/totno/{totno.2014}.png}\\   
    \includegraphics[width=\textwidth]{\bds/R/maps/species/snowcrab/lessertoadcrab/annual/totno/{totno.2014}.png}\\   
    \includegraphics[width=\textwidth]{\bds/R/maps/species/snowcrab/northernshrimp/annual/totno/{totno.2014}.png}  
  	\end{figure}
  	\end{column}

  	\begin{column}{0.25\textwidth}
 	\begin{figure}
    \includegraphics[width=\textwidth]{\bds/R/maps/species/snowcrab/jonahcrab/annual/totno/{totno.2015}.png}\\   
    \includegraphics[width=\textwidth]{\bds/R/maps/species/snowcrab/lessertoadcrab/annual/totno/{totno.2015}.png}\\   
    \includegraphics[width=\textwidth]{\bds/R/maps/species/snowcrab/northernshrimp/annual/totno/{totno.2015}.png}  
  	\end{figure}
  	\end{column}
...
Trends in biomass for potential predators (log10, no\textbackslash$km^2$) of Snow Crab on the Scotian Shelf, in the Snow Crab Survey
	...
	\begin{column}{0.25\textwidth}
 	\begin{figure}
    \includegraphics[width=\textwidth]{\bds/R/maps/species/snowcrab/halibut/annual/totno/{totno.2014}.png}\\   
    \includegraphics[width=\textwidth]{\bds/R/maps/species/snowcrab/cod/annual/totno/{totno.2014}.png}\\   
    \includegraphics[width=\textwidth]{\bds/R/maps/species/snowcrab/thornyskate/annual/totno/{totno.2014}.png}  
  	\end{figure}
  	\end{column}

  	\begin{column}{0.25\textwidth}
 	\begin{figure}
    \includegraphics[width=\textwidth]{\bds/R/maps/species/snowcrab/halibut/annual/totno/{totno.2015}.png}\\   
    \includegraphics[width=\textwidth]{\bds/R/maps/species/snowcrab/cod/annual/totno/{totno.2015}.png}\\   
    \includegraphics[width=\textwidth]{\bds/R/maps/species/snowcrab/thornyskate/annual/totno/{totno.2015}.png}  
  	\end{figure}
  	\end{column}
...
\begin{columns}
	...
	\end{center}
	\begin{figure}
		\includegraphics[width=\textwidth]{\bds/R/maps/survey/snowcrab/annual/{totno.female.multiparous}/{totno.female.multiparous.2015}.png}	
	\end{figure}
	\end{column}
	\end{columns}
\end{frame}
...
\frametitle{Mature Females}
	...
	\begin{column}{0.5\textwidth}
	\begin{figure}
	  \includegraphics[width=0.7\textwidth]{\bdsay/timeseries/survey/{totno.female.mat.combined}.pdf}
	\end{figure}
	\end{column}

	\begin{column}{0.5\textwidth}
	\begin{figure}
	\includegraphics[width=\textwidth]{\bds/R/maps/survey/snowcrab/annual/{totno.female.mat}/{totno.female.mat.2015}.png}	
	\end{figure}
	\end{column}
	\end{columns}
\end{frame}
...
\begin{column}{0.5\textwidth}
	...
	\end{center}
	\begin{figure}
		\includegraphics[width=0.9\textwidth]{\bds/R/maps/survey/snowcrab/annual/{R0.mass}/{R0.mass.2015}.png}
	\end{figure}
\end{column}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.9\textwidth]{\bdsay/figures/bugs/survey/{biomass.timeseries}.png}
\end{figure}
\end{column}
...
\begin{figure}
    \includegraphics[width=0.6\textwidth]{\bdsay/figures/bugs/survey/{fishingmortality.timeseries}.png}
\end{figure}
\end{column}

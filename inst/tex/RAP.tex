...
Environmental factors: Temperature, Depth and Substrate
    ...
    \includegraphics[width=\textwidth]{\bd/bio.indicators/substrate/R/{substrate.grainsize.edit}.png}  
  	...
  	\begin{column}{0.25\textwidth}
 	\begin{figure}
    \includegraphics[width=\textwidth]{\bd/emgis/bathymetry/maps/SSE/depth.png}\\   
    \includegraphics[width=\textwidth]{\bd/emgis/bathymetry/maps/SSE/slope.png}\\   
    \includegraphics[width=\textwidth]{\bd/emgis/bathymetry/maps/SSE/curvature.png}  
  	\end{figure}
  	\end{column}
...
Ecological factors: Species Composition, Species Diversity and Metabolic Rate
	...
	\begin{column}{0.25\textwidth}
 	\begin{figure}
    \includegraphics[width=\textwidth]{\bd/emgis/speciescomposition/maps/ca1/snowcrab/annual/{ca1.mean.\yr}.png}\\   
    \includegraphics[width=\textwidth]{\bd/emgis/speciesarea/maps/Npred/snowcrab/annual/{Npred.mean.\yr}.png}\\   
    \includegraphics[width=\textwidth]{\bd/emgis/metabolism/maps/mr/snowcrab/annual/{mr.mean.\yr}.png}  
  	\end{figure}
  	\end{column}

  	\begin{column}{0.25\textwidth}
 	\begin{figure}
    \includegraphics[width=\textwidth]{\bd/emgis/speciescomposition/maps/ca2/snowcrab/annual/{ca2.mean.\yr}.png}\\   
    \includegraphics[width=\textwidth]{\bd/emgis/speciesarea/maps/Z/snowcrab/annual/{Z.mean.\yr}.png}\\    
    \includegraphics[width=\textwidth]{\bd/emgis/metabolism/maps/smr/snowcrab/annual/{smr.mean.\yr}.png}  
  	\end{figure}
  	\end{column}

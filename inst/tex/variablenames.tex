...
\usepackage{amsfonts}
\usepackage{amssymb}
\title{BIO Models Abbreviations and Sources}
\begin{document}
\maketitle
\begin{description}
	...
	\item[dZ] slope
	\item[ddZ] curvature
	\item[tmean.climatology]  temperature mean from climatology
	\item[tsd.climatology] temperature sd from climatology
	...
	\item[ca1] correspondence analysis axis 1 from species composition analysis (speciescomposition_db.r)
	\item[ca2] correspondence analysis axis 2 from species area (speciescomposition_db.r)

...
#Map the Area
    require(PBSmapping)
    require(SpatialHub)
    bioLibrary ( 'spacetime','bio.utilities','emgis' )
...
# 
# d = rbind(d,set16[emgis::polygon_inside(set16,'cfa4x'),c('yr','totmass.male.com',"totmass.male.ncom","totmass.female.mat","totmass.female.imm")])
# 

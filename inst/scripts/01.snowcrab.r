...
# create base set data and add all historical data fixes
  ...
  if (get.base.data) {
    ...
    p$netmensuration.problems = c("netmind.S09092006.13.832.0.32.363", "minilog.S14102007.11.392.23.53.291") # add troublesome id's here .. eventually move into their respective functions

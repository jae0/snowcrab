...
# create base set data and add all historical data fixes
  ...
  if (get.base.data) {
    ...
    p$netmensuration.problems = c("seabird.S20112015.9.506.0.53.4", "minilog.S19092004.5.207.14.4.201", "minilog.S12072001.1.NA.8.40.256", "netmind.S09092006.13.832.0.32.363", "minilog.S14102007.11.392.23.53.291") # add troublesome id's here .. eventually move into their respective functions
